  ...
  try {
    ...
    const txResult = await adminDb.runTransaction(async (tx) => {
      ...
      writeActivityLog(tx, adminDb, {
        ...
        description: `Posted ${targetItem.name} x${quantity} on the marketplace for ${totalPrice.toLocaleString("en-US")} Loot Coins.`,
        ...
        metadata: {
          actionLabel: "Item Posted on Marketplace",
          sourceLabel: "Inventory",
          resultLabel: `${targetItem.name}`,
