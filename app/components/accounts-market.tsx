        ...
        <div className="mt-6 grid gap-4 lg:grid-cols-3">
          {filteredListings.map((account) => (
            ...
            >
              ...
              <div
                className={`market-smoke-layer ${isTbc ? "market-smoke-layer-tbc" : "market-smoke-layer-midnight"}`}
                aria-hidden="true"
              />
              <div className="market-smoke-particles" aria-hidden="true">
                <span className="market-smoke-orb market-smoke-orb-a" />
                <span className="market-smoke-orb market-smoke-orb-b" />
                <span className="market-smoke-orb market-smoke-orb-c" />
              </div>
