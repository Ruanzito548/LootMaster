                          ...
                          return (
                            ...
                            >
                              <div className="relative flex h-full w-full items-end">
                                ...
                                <div className="pointer-events-none absolute bottom-[calc(100%+28px)] left-1/2 z-20 hidden w-max -translate-x-1/2 rounded-xl border border-white/10 bg-[#11141C] px-3 py-2 text-xs text-slate-200 shadow-[0_14px_30px_rgba(0,0,0,0.45)] group-hover:block">
