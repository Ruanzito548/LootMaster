  ...
  return (
    <div className="min-h-screen bg-black text-green-400">
      <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col px-6 pb-20 pt-12 lg:px-8">
        ...
        <h1 className="mt-4 text-4xl font-black leading-tight text-green-300 sm:text-5xl">Albion Online</h1>
        <p className="mt-4 max-w-2xl text-base leading-8 text-green-600">
          Structure created. Add Albion game categories and settings here.
        </p>
