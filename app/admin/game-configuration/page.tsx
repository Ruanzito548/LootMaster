    ...
    <div className="min-h-screen bg-black text-green-300">
      <main className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            <p className="text-xs font-semibold uppercase tracking-wide text-green-600">Admin / Marketplace</p>
            <h1 className="mt-1 text-3xl font-semibold text-green-300 sm:text-4xl">Game Configuration</h1>
            <p className="mt-2 text-sm text-green-500">Controle central de jogos e categorias com refletimento imediato no site.</p>
          </div>
          {hasAnyDisabled ? (
