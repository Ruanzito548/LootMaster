...
export const CRAFT_RECIPES: CraftRecipe[] = [
  ...
  {
    id: "craft-gift-card-riot-10",
    title: "Riot Games Gift Card $10",
    description: "Craft a Riot Games Gift Card worth $10 using Gift Card Fragments.",
    outputType: "item",
    outputItem: {
      id: "gift-card-riot-10usd",
      name: "Riot Games Gift Card $10",
      category: "Gift Card",
      rarity: "rare",
      quantity: 1,
      iconPath: "/itens/general/ticket.png",
  ...
  {
    id: "craft-gift-card-riot-20",
    title: "Riot Games Gift Card $20",
    description: "Craft a Riot Games Gift Card worth $20 using Gift Card Fragments.",
    outputType: "item",
    outputItem: {
      id: "gift-card-riot-20usd",
      name: "Riot Games Gift Card $20",
      category: "Gift Card",
      rarity: "epic",
      quantity: 1,
      iconPath: "/itens/general/ticket.png",
  ...
  {
    id: "craft-gift-card-riot-50",
    title: "Riot Games Gift Card $50",
    description: "Craft a Riot Games Gift Card worth $50 using Gift Card Fragments.",
    outputType: "item",
    outputItem: {
      id: "gift-card-riot-50usd",
      name: "Riot Games Gift Card $50",
      category: "Gift Card",
      rarity: "legendary",
      quantity: 1,
      iconPath: "/itens/general/ticket.png",
